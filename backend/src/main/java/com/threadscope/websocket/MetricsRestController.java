 ...
 * GET  /api/snapshot         — full current metrics snapshot
 * GET  /api/threads          — thread list only
 * GET  /api/ai               — current AI diagnosis only
 * POST /api/chaos?on=true    — toggle chaos mode
 */
...
public class MetricsRestController {
    ...
    @Autowired private RealDisruptorEngine    disruptor;
    @Autowired private MetricsWebSocketHandler wsHandler;
